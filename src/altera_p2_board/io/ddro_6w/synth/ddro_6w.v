...
module ddro_6w (
	...
	ddro_6w_altera_gpio_2300_jrsykna gpio_0 (
		.ck        (ck),        //   input,  width = 1,        ck.export
		.datain_h  (datain_h),  //   input,  width = 6,  datain_h.fragment
		.datain_l  (datain_l),  //   input,  width = 6,  datain_l.fragment
		.dataout   (dataout),   //  output,  width = 6,   pad_out.export
