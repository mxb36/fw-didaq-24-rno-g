...
module jesd_gts_reset_sequencer_intel_srcss_gts_401_467auiy  #(
// shoreline sequencer:
   ...
   input  i_refclk_bus_out,
   output o_shoreline_refclk_fail_stat
  );
//=================================================================
//                          Shoreline sequencer
//=================================================================  
assign o_shoreline_refclk_fail_stat = i_refclk_bus_out;
