...
module jesd_gts_reset_sequencer (
	...
	jesd_gts_reset_sequencer_intel_srcss_gts_401_467auiy #(
		.SRC_RS_DISABLE      (0),
		.NUM_LANES_SHORELINE (12),
		.NUM_BANKS_SHORELINE (3)
	) intel_srcss_gts_0 (
		.o_src_rs_grant               (o_src_rs_grant),               //  output,  width = 12,               o_src_rs_grant.src_rs_grant
		.i_src_rs_priority            (i_src_rs_priority),            //   input,  width = 12,            i_src_rs_priority.src_rs_priority
		.i_src_rs_req                 (i_src_rs_req),                 //   input,  width = 12,                 i_src_rs_req.src_rs_req
		.o_pma_cu_clk                 (o_pma_cu_clk),                 //  output,   width = 3,                 o_pma_cu_clk.clk
		.i_refclk_bus_out             (i_refclk_bus_out),             //   input,   width = 1,             i_refclk_bus_out.refclk_bus_out
		.o_shoreline_refclk_fail_stat (o_shoreline_refclk_fail_stat)  //  output,   width = 1, o_shoreline_refclk_fail_stat.shoreline_refclk_fail_stat
	);
